...
from slimdqn.algorithms.mmic51shared import MMIC51Shared, set_target_params, shift_params
...
class TestMMIC51Shared(unittest.TestCase):
    ...
    def test_loss(self) -> None:
        ...
        logits = self.q.online_networks.apply(self.q.params, sample.state).reshape(-1, self.n_actions, self.n_bins)
    ...
    def test_best_action(self):
        ...
        logits = self.q.online_networks.apply(self.q.params, state).reshape(-1, self.n_actions, self.n_bins)
