...
from slimdqn.algorithms.mmc51 import MMC51
...
class TestMMC51(unittest.TestCase):
    ...
    def test_compute_target(self) -> None:
        ...
        weights = jax.nn.softmax(self.q.omega * next_q_values)
        next_probabilities_target = weights @ next_probabilities
