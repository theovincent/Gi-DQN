...
from slimdqn.algorithms.mmc51rcshared import MMC51RCShared
...
class TestMMC51RCShared(unittest.TestCase):
    ...
    def test_compute_target(self) -> None:
        ...
        weights = jax.nn.softmax(self.q.omega * next_q_values)  # (n_actions,)
