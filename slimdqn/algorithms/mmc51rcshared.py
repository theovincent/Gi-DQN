...
class MMC51RCShared:
    ...
    def loss(self, params: FrozenDict, sample: ReplayElement, importance_weight):
        ...
        td_loss = jnp.sum(target_distribution * jax.lax.stop_gradient(h_logits), axis=-1) + cross_entropy
    ...
    def compute_target(self, params: FrozenDict, sample: ReplayElement):
        ...
        next_probabilities_target = (
            boltzmann_policy @ q_next_probabilities
        )  # (n_bins,); convex mixture of distributions
