SHARED_ARGS="--features 32 32 --replay_buffer_capacity 10_000 --batch_size 32 --update_horizon 1 --gamma 0.99 \
  --horizon 1_000 --n_epochs 10 --n_training_steps_per_epoch 10_000 --n_initial_samples 1_000 --epsilon_end 0.01 \
  --epsilon_duration 1_000 -at fc"
...
do
  ...
  do
    SHARED_NAME="sa25_utd${UPDATE_TO_DATA}_wd${WEIGHT_DECAY}_tuf${tuf}_lr${lr}"
    SHARED_ARGS="$SHARED_ARGS --first_seed 1 --last_seed 10 --n_parallel_seeds 1 --learning_rate $lr --target_update_frequency $tuf"
