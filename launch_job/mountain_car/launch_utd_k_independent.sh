...
UPDATE_TO_DATA=(8 10) #(1 3 5 8 10)
FEATURES=(300)  #(5 14 39 108 300)
...
do
  ...
  do
    SHARED_NAME="sa25_utd${utd}_f${features}_wd${WEIGHT_DECAY}_tuf${TARGET_UPDATE_FREQUENCIES}_lr${LEARNING_RATES}_nbi${N_BELLMAN_ITERATIONS}_independent"
