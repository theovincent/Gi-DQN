...
do
    ...
    do
        ...
        do
            ...
            launch_job/atari/${PLATFORM}_sc51.sh --first_seed 1 --last_seed 5 --n_parallel_seeds 1 $SHARED_ARGS \
                --target_update_period $TARGET_UPDATE_PERIOD \
                --experiment_name ${SHARED_NAME}_T${TARGET_UPDATE_PERIOD}_${GAME}

            launch_job/atari/${PLATFORM}_isc51shared.sh --first_seed 1 --last_seed 5 --n_parallel_seeds 1 $SHARED_ARGS \
                --target_update_period $TARGET_UPDATE_PERIOD \
            ...
            launch_job/atari/${PLATFORM}_gisc51shared.sh --first_seed 1 --last_seed 5 --n_parallel_seeds 1 $SHARED_ARGS \
                --target_update_period $TARGET_UPDATE_PERIOD\
            ...
            # UNFREEZE FIRST HEAD TRUE
            launch_job/atari/${PLATFORM}_gisc51shared.sh --first_seed 1 --last_seed 5 --n_parallel_seeds 1 $SHARED_ARGS \
                --target_update_period $TARGET_UPDATE_PERIOD\
                --n_bellman_iterations $N_BELLMAN_ITERATIONS --weight_decay $WEIGHT_DECAY --unfreeze_first_head \
                --experiment_name ${SHARED_NAME}_T${TARGET_UPDATE_PERIOD}_K${N_BELLMAN_ITERATIONS}_WD${WEIGHT_DECAY}_${GAME}
        done
    done
done
