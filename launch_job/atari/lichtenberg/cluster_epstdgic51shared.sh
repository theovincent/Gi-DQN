...
sbatch -A l0003303 --job-name $EXPERIMENT_NAME-$ALGO_NAME --array=$FIRST_SEED-$LAST_SEED:$N_PARALLEL_SEEDS --ntasks=1 --cpus-per-task=1 --mem-per-cpu=$((N_PARALLEL_SEEDS * 1250))M --time=24:00:00 --partition dflt \
