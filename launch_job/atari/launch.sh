...
C51_ARGS="--experiment_name Test_${SHARED_NAME}_T${TARGET_UPDATE_PERIOD}_${GAME}"
...
# C51RC_ARGS="--experiment_name Test_WD${WEIGHT_DECAY}_${SHARED_NAME}_${GAME} --weight_decay $WEIGHT_DECAY"
...
# IC51_ARGS="--experiment_name Test_K${N_BELLMAN_ITERATIONS}_${SHARED_NAME}_T${TARGET_UPDATE_PERIOD}_${GAME} --n_bellman_iterations $N_BELLMAN_ITERATIONS"
...
# GIC51_ARGS="--n_bellman_iterations $N_BELLMAN_ITERATIONS --weight_decay $WEIGHT_DECAY --experiment_name Test_K${N_BELLMAN_ITERATIONS}_WD${WEIGHT_DECAY}_${SHARED_NAME}_T${TARGET_UPDATE_PERIOD}_${GAME}"
...
C51RCSHARED_ARGS="--experiment_name Test_WD${WEIGHT_DECAY}_${SHARED_NAME}_${GAME} --weight_decay $WEIGHT_DECAY"
...
IC51SHARED_ARGS="--experiment_name Test_K${N_BELLMAN_ITERATIONS}_${SHARED_NAME}_T${TARGET_UPDATE_PERIOD}_${GAME} --n_bellman_iterations $N_BELLMAN_ITERATIONS"
launch_job/atari/${PLATFORM}_ic51shared.sh --first_seed 1 --last_seed 3 --n_parallel_seeds 3 $SHARED_ARGS $IC51SHARED_ARGS
# launch_job/atari/${PLATFORM}_ic51shared.sh --first_seed 4 --last_seed 5 --n_parallel_seeds 2 $SHARED_ARGS $IC51SHARED_ARGS

GIC51SHARED_ARGS="--n_bellman_iterations $N_BELLMAN_ITERATIONS --weight_decay $WEIGHT_DECAY --experiment_name Test_K${N_BELLMAN_ITERATIONS}_WD${WEIGHT_DECAY}_${SHARED_NAME}_T${TARGET_UPDATE_PERIOD}_${GAME}"
