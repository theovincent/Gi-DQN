...
# then
#     launch_job/atari/${PLATFORM}_gidqn.sh --first_seed 1 --last_seed 3 --n_parallel_seeds 3 $SHARED_ARGS $GIDQN_ARGS --freeze_first_head \
#     --experiment_name L2_K${N_BELLMAN_ITERATIONS}_WD${WEIGHT_DECAY}_${SHARED_NAME}_${GAME}
#     launch_job/atari/${PLATFORM}_gidqn.sh --first_seed 4 --last_seed 5 --n_parallel_seeds 2 $SHARED_ARGS $GIDQN_ARGS --freeze_first_head \
#     --experiment_name L2_K${N_BELLMAN_ITERATIONS}_WD${WEIGHT_DECAY}_${SHARED_NAME}_${GAME}
# else
...
# if [ $FREEZE_FIRST_HEAD == 1 ]
# then
#     launch_job/atari/${PLATFORM}_gidqnshared.sh --first_seed 1 --last_seed 3 --n_parallel_seeds 3 $SHARED_ARGS $GIDQNSHARED_ARGS --freeze_first_head \
#     --experiment_name L2_K${N_BELLMAN_ITERATIONS}_WD${WEIGHT_DECAY}_${SHARED_NAME}_${GAME}
#     # launch_job/atari/${PLATFORM}_gidqnshared.sh --first_seed --first_seed 4 --last_seed 5 --n_parallel_seeds 2 $SHARED_ARGS $GIDQNSHARED_ARGS --freeze_first_head \
#     # --experiment_name L2_K${N_BELLMAN_ITERATIONS}_WD${WEIGHT_DECAY}_${SHARED_NAME}_${GAME}
# # else
